...
function bpc_insert_data() {
    ...
    if(count($result) > 0){
        ...
        $all_items = array(
            ...
            array( 'title' => 'Privacy Policy', 'description' => 'Set up your Privacy Policy, as per the POPI Act, you are required to have a Privacy Policy in place... Be specific - go to <a href="./options-privacy.php">Privacy Policy</a> to set it up now.', 'type' => 0 ),
            ...
            array( 'title' => 'Printable Form Creation', 'description' => 'You need to set up a printable document (Consent Form) that you can provide to each of your clients. This consent form needs to be filled out and signed, then be returned for filing and will serve as your proof that you have consent to process the data of such data subject. The consent form needs to cover the following sections for you to be compliant.', 'type' => -1 ),
            ...
            array( 'title' => '6. LEGAL REQUIREMENT:', 'description' => 'State the act and a link to where the act can be accessed -> "Protection of Personal Information Act 4 of 2013 | POPIA -  https://manageconsent.co.za/popia"', 'type' => 1 ),
...
function Be_POPIA_Compliant_echo_footer() {
    ...
    if(($rowcount == 100) || ((isset($result_api->value) && $result_api->value != '') && ((isset($result_company->value)) && $result_company->value != ''))){
